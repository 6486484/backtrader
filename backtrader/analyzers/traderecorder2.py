...
class TradeRecorder2(Analyzer):
    ...
    def notify_trade(self, trade):
        ...
        #print('start append')
        self.rets.allTrades.append(trade)
        #print('end append')
        pass
    ...
    def stop(self):
        ...
        print('TRADE RECORDER ANALYZ STOPPING! yes')  # REMOVE
        ...
        self.rets.openTrades = [69,6969,69]   # REMOVE DUMMY
        self.rets.closedTrades = [666,777,666]  # REMOVE DUMMY
